...
export const defaultDirectorParagraphs = [
  ...
  "Timely publication, transparent communication, comprehensive editing, and strong relationships with authors and readers have been the hallmarks of our journals. {publisher} provides a platform for publishing scholarly research articles that meet international standards. We strive to publish high-quality papers in a timely manner, establishing ourselves as a trusted leader in scholarly publishing and academic services.",
